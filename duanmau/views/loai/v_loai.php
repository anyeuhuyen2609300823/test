                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="item-one" role="tabpanel" aria-labelledby="item-one-tab">
                                <div class="shop-details-img">
                                    <img src="public/layout/img/product/shop_details_img01.jpg" alt="">
                                </div>
                            </div>
                        ...
                        <div class="cart-plus-minus">
                            <form action="#" class="num-block">
                                ...
                                <div class="qtybutton-box">
                                    <span class="plus"><img src="public/layout/icon/plus.png" alt=""></span>
                                    <span class="minus dis"><img src="public/layout/icon/minus.png" alt=""></span>
                                </div>
                            </form>
                        </div>
